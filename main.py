...
from data.dcoke_dataset import KBCDataset, PathqueryDataset
...
def main():
    ...
    if args.task_name == "triple":
        ...
        train_dataset = KBCDataset(data_path='/data/private/wanghuadong/mnt/liangshihao/wikidata5m/train_demo.txt',
        ...
        val_dataset = KBCDataset(data_path='/data/private/wanghuadong/mnt/liangshihao/wikidata5m/valid.txt',
                                   desc_path='/data/private/wanghuadong/mnt/liangshihao/wikidata5m/wikidata5m_text.txt',
                                   relation_file='/data/private/wanghuadong/mnt/liangshihao/wikidata5m/wikidata5m_relation.txt',
                                   entity_file='/data/private/wanghuadong/mnt/liangshihao/wikidata5m/wikidata5m_entity.txt',
                                   max_seq_len=1024,
