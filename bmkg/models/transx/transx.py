...
class TransX(BMKGModel, ABC):
    ...
    def __init__(self, config: argparse.Namespace):
        ...
        self.ent_embed = nn.Embedding(config.ent_size, config.dim, max_norm=1, sparse=config.sparse)
        self.rel_embed = nn.Embedding(config.rel_size, config.dim, max_norm=1, sparse=config.sparse)
    ...
    def add_args(cls, parser: argparse.ArgumentParser):
        ...
        parser.add_argument("--sparse", default=False, help="Use sparse gradient")
